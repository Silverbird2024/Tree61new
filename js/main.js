...
$scope.Health_click = function() {$scope.GotoPage( "Healthnew" );};
$scope.PushButton13_click = function() {$scope.GotoPage( "Starkie" );};
$scope.PushButton14_click = function() {$scope.GotoPage( "Kingsway" );};
$scope.PushButton20_click = function() {$scope.GotoPage( "Prayer" );};
$scope.PushButton21_click = function() {$scope.GotoPage( "Meditation" );};
$scope.PushButton28_click = function() {$scope.GotoPage( "PlanRPlus" );};
...
$scope.PushButton32_click = function() {$App.work01 = localStorage.getItem("Work1Notes");
$App.work02 = localStorage.getItem("Work2Notes");
$App.Appdev01 = localStorage.getItem("Appdev1Notes");
$App.Appdev02 = localStorage.getItem("Appdev2Notes");
$App.Appdev03 = localStorage.getItem("Appdev3Notes");
...
$App.Prayer1 = localStorage.getItem("Prayer1");
$App.Prayer2 = localStorage.getItem("Prayer2");
$.get("datasource.txt", function(response){$App.DateInputwork = response;});
$scope.GotoPage( "save" );};
...
$scope.PushButton57_click = function() {$scope.GotoPage( "Title" );};
$scope.PushButton68_click = function() {$scope.GotoPage( "Book1" );};
});
...
$scope.PushButton54_click = function() {$App.Decisions01 = localStorage.getItem("Decisions1Notes");
$App.Decisions02 = localStorage.getItem("Decisions2Notes");
$App.Decisions03 = localStorage.getItem("Decisions3Notes");
$App.Decisions04 = localStorage.getItem("Decisions4Notes");
$App.Decisionsstone = localStorage.getItem("DecisionsStoneNotes");};
});
...
$scope.TextArea38_change = function() {localStorage.setItem("Work5Notes",$App.work05);};
$scope.TextArea36_change = function() {localStorage.setItem("Work6Notes",$App.work06);};
});
...
$scope.PushButton47_click = function() {$scope.GotoPage( "TreeHome" );};
...
NeoApp.controller("lanRPlus_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 17;
$App.NAB.PageID = "lanRPlus";
...
$scope.PushButton8_click = function() {$App.BR01 = localStorage.getItem("BR1");
$App.BR02 = localStorage.getItem("BR2");};
...
$scope.TextInput3_change = function() {localStorage.setItem("Title22",$App.Title22);};
$scope.TextInput4_change = function() {localStorage.setItem("Title23",$App.Title23);};
$scope.TextInput5_change = function() {localStorage.setItem("Title24",$App.Title24);};
$scope.PushButton56_click = function() {$scope.GotoPage( "TreeHome" );};
$scope.TextInput1_change = function() {localStorage.setItem("Title25",$App.Title25);};
});
